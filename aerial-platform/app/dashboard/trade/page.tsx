      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 mb-4">
            This is your contractor dashboard. Here you'll be able to:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>Browse local jobs in your service area</li>
            <li>Submit bids on projects</li>
            <li>Message clients</li>
            <li>Manage your business profile</li>
            <li>View your earnings and ratings</li>
          </ul>
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              📍 <strong>Next up:</strong> Complete onboarding to start bidding
              (US-008)
            </p>
          </div>
        </div>
